					...
					<section className="bg-white py-24">
						<div className="container mx-auto px-6 sm:px-12 sm:mx-auto flex flex-col gap-9 ">
							...
							<ul className="list-disc list-inside space-y-2 ">
								...
								<li className="list-disc text-base  text-dark list-item list-inside">
									Lolwah Hotels has the right to change the rates without any
									prior notice.
								</li>
								<li className="list-disc text-base  text-dark list-item list-inside">
								...
								<li className="list-disc text-base  text-dark list-item list-inside">
									Lolwah Hotels FZ LLC maintains lolwahotels.com.
								</li>
								<li className="list-disc text-base  text-dark list-item list-inside">
							...
							<div className="flex flex-col gap-3">
								...
								<ul className="list-disc list-inside space-y-2">
									<li className="list-disc text-base  text-dark list-item list-inside">
										Lolwah Hotels provide you the best rates available in Makkah
										and Madinah.
									</li>
								</ul>
							</div>
							<div className="flex flex-col gap-3">
								...
								<ul className="list-disc list-inside space-y-2">
									<li className="list-disc text-base  text-dark list-item list-inside">
										Lolwah Hotels ensures that all credit/debit cards details
										and personally identifiable information will NOT be stored,
										sold, shared, rented or leased to any third parties.
									</li>
									<li className="list-disc text-base  text-dark list-item list-inside">
										Lolwah Hotels will not pass any debit/credit card details to
										third parties.
									</li>
									<li className="list-disc text-base  text-dark list-item list-inside">
										Lolwah Hotels takes appropriate steps to ensure date privacy
										and security including through various hardware and software
										methodologies. However, lolwahotels.com cannot guarantee the
										security of any information that is disclosed online.
									</li>
									<li className="list-disc text-base  text-dark list-item list-inside">
										Lolwah Hotels is not responsible for the privacy policies of
										websites to which itlinks. If you provide any information to
									...
									<li className="list-disc text-base  text-dark list-item list-inside">
										Lolwah Hotels Policies and Terms & Conditions may be changed
										or updated occasionally to meet the requirement and
