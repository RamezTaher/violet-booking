					...
					<section className="bg-white py-24">
						<div className="container mx-auto px-6 sm:px-12 sm:mx-auto flex flex-col gap-9 ">
							...
							<p className="text-base  text-dark">
								...
								booking.lolwahotels.com. This policy is not applicable to any
							...
							<div className="flex flex-col gap-3">
								...
								<p className="text-base  text-dark">
									booking.lolwahotels.com follows a standard procedure of using
							...
							<div className="flex flex-col gap-3">
								...
								<p className="text-base  text-dark">
									Like any other website, booking.lolwahotels.com uses cookies.
							...
							<div className="flex flex-col gap-3">
								...
								<p className="text-base  text-dark">
									Note that booking.lolwahotels.com has no access to or control
							...
							<div className="flex flex-col gap-3">
								...
								<p className="text-base  text-dark">
									{
										"booking.lolwahotels.com's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options."
									}
								</p>
								<p className="text-base  text-dark">
									{
